...
#define DEF_WLAN_2G_SSID	"PHICOMM_%s"
#define DEF_WLAN_5G_SSID	"PHICOMM_5G_%s"
#define DEF_WLAN_2G_GSSID	"PHICOMM_GUEST_%s"
#define DEF_WLAN_5G_GSSID	"PHICOMM_GUEST_5G_%s"
