...
#define DEF_WLAN_2G_SSID	PHICOMM "_%s"
#define DEF_WLAN_5G_SSID	PHICOMM "_5G_%s"
#define DEF_WLAN_2G_GSSID	PHICOMM "_GUEST_%s"
#define DEF_WLAN_5G_GSSID	PHICOMM "_GUEST_5G_%s"
